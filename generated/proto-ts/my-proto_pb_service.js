...
MyService.MessageFileStream = {
  methodName: "MessageFileStream",
  service: MyService,
  requestStream: false,
  responseStream: true,
  requestType: my_proto_pb.MessageFileStreamRequest,
  responseType: my_proto_pb.MessageFileStreamResponse
};
...
MyServiceClient.prototype.messageFileStream = function messageFileStream(requestMessage, metadata) {
  var listeners = {
    data: [],
    end: [],
    status: []
  };
  var client = grpc.invoke(MyService.MessageFileStream, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
